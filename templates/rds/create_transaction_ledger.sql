...
grant select (transaction_id, account_id, creation_time, transaction_type, settlement_status, amount, currency, unit, human_reference) on transaction_data.core_transaction_ledger to admin_api_worker;

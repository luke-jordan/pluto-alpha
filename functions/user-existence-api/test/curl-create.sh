...
# docker run --net="unnamed_default" --rm -v "$PWD":/var/task lambci/lambda:nodejs12.x handler.create '{"ownerUserId": "2c957aca-47f9-4b4d-857f-a3205bfc6a78"}' --network bridge
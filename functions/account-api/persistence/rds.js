...
const logger = require('debug')('u:persistence:rds');
...
module.exports.insertAccountRecord = async (accountDetails = { 
    ...
    try {
        ...
        const queryString = `insert into ${tableName} (account_id, owner_user_id, opening_user_id, user_first_name, user_last_name) ` +
            `values ($1, $2, $3, $4, $5) returning account_id, tags, flags`;
        const queryValues = [accountDetails['accountId'], accountDetails['ownerUserId'], openingUserId, accountDetails['userFirstName'], accountDetails['userFamilyName']];
    ...
    return { statusCode: 200, entity: responseEntity };
};